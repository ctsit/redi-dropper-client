...
"use strict";
  ...
  var Resumable = function(opts) {
    ...
    // Extra data changing based on the parrent application state
    $.extra = {};
    ...
    // -------------------------------------------------------------------------------
    // INTERNAL OBJECT TYPES: ResumableFile, ResumableChunk
    ...
    function ResumableChunk(resumableObj, fileObj, offset, callback) {
      ...
      $.send = function() {
        ...
        var extraData = $.resumableObj.getExtraData();

        // Set up the basic query data from Resumable
        var query = {
          subject_id: extraData['subject_id'],
          event_id: extraData['event_id'],
